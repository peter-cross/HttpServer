...
class HttpServerTest {
    ...
    classItemTest() {
        ...
        let itmQty = 5;
        let itmObj = new core_component_1.Item(itmName, itmQty);
    ...
    classIngredientTest() {
        ...
        let ingrQty = 5;
        let ingrObj = new core_component_1.Ingredient(ingrName, ingrQty);
     ...
     */
    classRecipeTest() {
        let ingr1 = new core_component_1.Ingredient('Ingredient 1', 10);
        let ingr2 = new core_component_1.Ingredient('Ingredient 2', 20);
        ...
        let rcpObj = new core_component_1.Recipe("Recipe 1", ingredients, instructions, estimatedTime);
        ...
        it('adds item to recipe ', () => {
            let newIngr = new core_component_1.Ingredient('New ingredient', 50);
...
new HttpServerTest();
//# sourceMappingURL=httpserver_test.js.map