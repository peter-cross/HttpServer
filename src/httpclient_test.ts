...
class HttpClientTest
{
        ...
        describe( 'Delete Recipe by recipe index', () => 
        {
            it( 'should delete Recipes by specified recipe index', ( done ) => 
            {
                ...
                request.get( url, ( err, resp, body ) => 
                {
                    ...
                    let remainingRecipes = new Array<String>()
    ...
    testPostAddRecipe()
    {
        let ingr1 = new Ingredient( 'Ingredient 2', 20 )
        let ingr2 = new Ingredient( 'Ingredient 1', 10 )
        ...
        let rcpObj = new Recipe( "Recipe 2", ingredients, instructions, estimatedTime )
        ...
        describe( 'Add Recipe object', () => 
        {
            it( 'should add Recipe object', ( done ) => 
            {
                ...
                {
                    let recipes = <Array<Recipe>>body
                    
                    let recipeList = new Array<String>()
